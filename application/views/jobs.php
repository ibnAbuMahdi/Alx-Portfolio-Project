  ...
  <div class="btn-group w-100 align-items-center justify-content-between flex-wrap py-4">
      ...
      <section>
        <div class="row gy-4">
          ...
          <div class=col-6 >
            <div class="card ongoingJob">
              <div class="card-header">
                <div class=row>
                  <div class=col-6>Client name</div>
                  <div class="col-6 finishDate">08/25/2023 (4 weeks 3 days)</div>                
                </div>
              </div>
              <div class="card-body">
                <h5 class="card-title">Job title</h5>
              ...
              <div class="progress mb-3">
                <div class="progress-bar bg-info text-dark w-50" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">50%</div>
              </div>
            </div>
          </div>
          <div class=col-6 >
